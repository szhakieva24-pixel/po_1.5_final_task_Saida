...
(
    ...
    (select client_id from pharmacy.clients  where email = 'maria@example.kz'),
...
(
    ...
    (select client_id from pharmacy.clients  where email = 'elena@example.kz'),
...
(
    ...
    (select client_id from pharmacy.clients  where email = 'ivan@example.kz'),
...
(
    ...
    (select client_id from pharmacy.clients  where email = 'alex@example.kz'),
...
(
    ...
    (select client_id from pharmacy.clients  where email = 'dmitry@example.kz'),
...
-- INSERT ... SELECT: populate sale_items for Ivan's purchase using subquery join
